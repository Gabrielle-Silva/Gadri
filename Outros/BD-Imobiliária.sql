...
update agendamento set 
	data_cancelamento = '2022-06-10', horario_cancelamento = '14:30:00' 
where cod=2;

select * from agendamento where cod = 2;
...
select u.cod as 'cod_usuario',u.nome , a.data, h.horario, ci.cod as 'cod_imovel', ci.logradouro, ci.numero, ci.complemento, b.bairro, c.cidade, a.horario_cancelamento, a.data_cancelamento
from agendamento a
...
select i.cod, f.descricao as 'finalidade', t.descricao as 'tipo', i.m2, i.quartos, i.vagas, i.valor, i.obs, i.foto, i.logradouro, i.numero, i.complemento, b.bairro, c.cidade, i.desativacao
from imovel i
...
select fav.cod, fav.cod_usuario, u.nome, u.telefone, u.e_mail, fav.cod_imovel, f.descricao as 'finalidade', t.descricao as 'tipo', i.m2, i.quartos, i.vagas, i.valor, i.obs, i.foto, i.logradouro, i.numero, i.complemento, b.bairro, c.cidade, i.desativacao
from favorito fav
inner join usuario u
